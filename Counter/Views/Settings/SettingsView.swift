...
struct ProfileInlineEditView: View {
    ...
    /// Personal contact mirrors studio contact when true.
    @State private var personalSameAsStudio: Bool = false
    /// Studio contact mirrors personal contact when true.
    @State private var studioSameAsPersonal: Bool = false
    /// Billing address mirrors studio address when true.
    @State private var billingSameAsStudio: Bool
