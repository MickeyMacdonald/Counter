...
//  formal addition of `Discount`, which existed as a `@Model` file
...
//  and querying `Discount` records, which meant pre-V2 the data was
...
//       `piece.sessionProgress` stages) will ride on this same V1 → V2 →
